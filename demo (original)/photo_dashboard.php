            ...
            <div class="column">
              ...
              foreach($Files as $source){
                ...
                if($count%$NumberSlidesInCols == 0){ // number of slides per slot before move to next column
                  $colcount+=1;
                  if($colcount ==4){$colcount=1;}// how many boxes/columns
                  echo(" </div></div>       
                  <div class='column'>
...
*/
        var zone = (Mpos / number_of_slides); // width of travel for one slide transition
        ...
        range = 620/number_of_slides;
        while (number <= number_of_slides) {
          //console.log('extra='+RowNum % 4); 
          extra=RowNum % 4;
          //$opacity = $Opacity-20*extra;
          if (RowNum % 4 == 0) {
            RowNum = 1;
          };
           $Opacity = zone-5;
